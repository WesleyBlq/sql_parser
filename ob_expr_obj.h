...
namespace oceanbase
{
    namespace common
    {
        ...
        public:
            ...
            int cast_to(int32_t dest_type, ObExprObj &result) const;
            // setters
            void set_null();
            ...
            void set_varchar(const string& value);
            ...
            const ObDateTime& get_datetime() const
            {
                return v_.datetime_;
            }

            const ObPreciseDateTime& get_precise_datetime() const
            {
                return v_.precisedatetime_;
            }

            const string& get_varchar() const
            {
                return varchar_;
            }

            const ObCreateTime& get_ctime() const
            {
                return v_.createtime_;
            }

            const ObModifyTime& get_mtime() const
            {
                return v_.modifytime_;
            }
            ...
            const ObNumber& get_decimal() const
            {
                return num_;
            }

            const int64_t get_ext() const
            {
                return v_.ext_;
            }
            ...
            int get_varchar(string& value) const;
            ...
            int substr(const ObExprObj &start_pos, ObExprObj &result) const;
            int substr(const ObExprObj &start_pos_obj, const ObExprObj &expect_length_obj, ObExprObj &result) const;
            int not_like(const ObExprObj &other, ObExprObj &result) const;
            int varchar_length(ObExprObj &res) const;
            int hex(ObExprObj &res);
            int unhex(ObExprObj &res);
            int ip_to_int(ObExprObj &res);
            int int_to_ip(ObExprObj &res);
            int upper_case(ObExprObj &result) const;
            int lower_case(ObExprObj &result) const;
            int concat(const ObExprObj &other, ObExprObj &result) const;
            int trim(const ObExprObj &trimType, const ObExprObj &trimPattern, ObExprObj &result) const;
        ...
        private:
            ...
            int cast_to_varchar(string &varchar) const;
        ...
        inline void ObExprObj::set_varchar(const string& value)
        {
            type_ = ObVarcharType;
            varchar_ = value;
        }
